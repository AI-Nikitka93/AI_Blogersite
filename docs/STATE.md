...
- Public filter cache version is now part of post list/detail cache keys; without that, Vercel Data Cache can keep old home/detail rows after a deploy that only changes filtering rules.
